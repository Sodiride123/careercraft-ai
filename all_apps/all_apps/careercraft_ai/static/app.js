/**
 * CareerCraft AI - Sarah Chen Career Consultant
...
class CareerCraftApp {
    ...
    async handleJobSubmit(mode) {
        ...
        if (actualMode === 'url') {
            ...
            if (jobInput.length < 50) {
                this.showInputError(this.jobAdTextInput, 'Please provide more details (at least 50 characters)');
                return;
            }
        }
    ...
    updateProgress(progress, step) {
        ...
        this.progressStatus.textContent = step || 'Sarah is working on your resume...';
    }
    ...
    showSuccess(data) {
        // Add success message from Sarah
        this.addAgentMessage(`
        ...
        const messageHtml = `
            <div class="message agent-message ${isSuccess ? 'success-message' : ''}">
                <div class="message-avatar">
                    <img src="/static/sarah-avatar.png" alt="Sarah">
                </div>
                <div class="message-content">
                    <div class="message-header">
                        <span class="message-name">Sarah Chen</span>
                        <span class="message-time">Just now</span>
                    </div>
                    <div class="message-bubble">
                        ${html}
